...
# Draw point cloud
from eulerangles import euler2matrix as euler2mat
...
def plot_colored_pointcloud(batch_points, batch_values, filename=None):
    ...
    assert batch_values.shape[1] == batch_points.shape[2:], "Points and Values array should have matching number of points"
